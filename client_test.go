...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Completions.New(context.Background(), omnistack.CompletionNewParams{
	...
	if userAgent != fmt.Sprintf("Omnistack/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Completions.New(context.Background(), omnistack.CompletionNewParams{
		Model:  omnistack.F(omnistack.CompletionNewParamsModelGpt3_5TurboInstruct),
		Prompt: omnistack.F[omnistack.CompletionNewParamsPromptUnion](shared.UnionString("This is a test.")),
	})
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Completions.New(cancelCtx, omnistack.CompletionNewParams{
		Model:  omnistack.F(omnistack.CompletionNewParamsModelGpt3_5TurboInstruct),
		Prompt: omnistack.F[omnistack.CompletionNewParamsPromptUnion](shared.UnionString("This is a test.")),
	})
	if err == nil || res != nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Completions.New(deadlineCtx, omnistack.CompletionNewParams{
			Model:  omnistack.F(omnistack.CompletionNewParamsModelGpt3_5TurboInstruct),
			Prompt: omnistack.F[omnistack.CompletionNewParamsPromptUnion](shared.UnionString("This is a test.")),
		})
		if err == nil || res != nil {
